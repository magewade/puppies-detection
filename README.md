...
> Этот проект показывает, как с помощью **YOLOv8** и **Streamlit** можно удобно обрабатывать видео локально: находить щенков на кадрах и визуализировать результат через простой интерфейс.
...
1. Пользователь выбирает демо-видео или загружает своё.
